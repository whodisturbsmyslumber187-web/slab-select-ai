  ...
  en: {
    ...
    portfolio: {
      ...
      projects: {
        ...
        bankLobby: {
          title: "International Bank HQ",
          description: "Grand banking hall with Calacatta marble floors, walls and dramatic reception desk with Nero Portoro accents.",
          location: "DIFC, Dubai",
          stone: "Calacatta & Nero Portoro",
        },
        fineDining: {
  ...
  ar: {
    ...
    portfolio: {
      ...
      projects: {
        ...
        bankLobby: {
          title: "المقر الرئيسي للبنك الدولي",
          description: "قاعة بنكية فخمة مع أرضيات وجدران كالاكاتا ومكتب استقبال درامي بلمسات نيرو بورتورو.",
          location: "مركز دبي المالي العالمي",
          stone: "كالاكاتا ونيرو بورتورو",
        },
        fineDining: {
          title: "مطعم نجمة ميشلان",
          description: "طاولة شيف رائعة مع كاونتر رخام بعروق ذهبية، غرفة طعام خاصة وبار على السطح مع إطلالات على أفق دبي.",
          location: "منطقة برج خليفة",
          stone: "كالاكاتا جولد كينتسوجي",
        },
        retailStore: {
          title: "متجر فلاجشيب الفاخر",
          description: "بوتيك أزياء راقي، صالة عرض مجوهرات ومعرض سيارات فاخرة مع أرضيات رخام مذهلة.",
          location: "دبي مول",
          stone: "كارارا وإمبرادور",
        },
        membersClub: {
          title: "نادي الأعضاء الخاص",
          description: "نادي حصري يضم مدفأة رخامية، بار درامي، صالة سيجار ومدخل درج فخم.",
          location: "وسط دبي",
          stone: "ستاتواريو وبورتورو الذهبي",
        },
        artGallery: {
          title: "متحف الفن المعاصر",
          description: "معرض عالمي المستوى مع أرضيات رخام مصقولة وأعمدة درامية وقواعد منحوتات.",
          location: "حي الفنون القوز",
          stone: "ستاتواريو فيناتو",
        },
        parisHotel: {
          title: "فندق قصر باريس",
          description: "بهو آرت ديكو فخم مع جدران كالاكاتا، درج كبير، صالة مدفأة رخامية ومكتب استقبال فني.",
          location: "الدائرة الثامنة، باريس",
          stone: "كالاكاتا أورو وأرابيسكاتو",
        },
        londonBank: {
          title: "بنك لندن الخاص",
          description: "قاعة بنكية مميزة مع أرضيات نيرو ماركينا، طاولة اجتماعات فيردي غواتيمالا واستقبال عملاء كالاكاتا.",
          location: "مايفير، لندن",
          stone: "نيرو ماركينا وفيردي غواتيمالا",
        },
        milanFashion: {
          title: "دار أزياء ميلانو",
          description: "بوتيك أزياء إيطالي أيقوني مع صالة عرض ستاتواريو، أتيليه VIP كالاكاتا ومدخل نيرو ماركينا.",
          location: "فيا مونتينابوليوني، ميلانو",
          stone: "ستاتواريو ونيرو ماركينا",
        },
        monacoClub: {
          title: "نادي يخوت موناكو",
          description: "نادي واجهة بحرية حصري مع بار تراس، غرفة طعام إمبرادور، استقبال رخامي وصالة بورتورو الذهبية الخاصة.",
          location: "ميناء هرقل، موناكو",
          stone: "كالاكاتا وبورتورو الذهبي",
        },
      },
    },
    // Services Section
